...
/*
  Using an if statement and a comparison operator, create code that will check if Amy or Brittani is older, and then console.log '{name} is older'. Hint: Consider 
  what will happen if they are the same age.
...
if (temperature > 80 && rain) {
  console.log('Wear a t-shirt and take an umbrella with you')
  ...
  console.log('looks like a day for a tshirt')
} else if (temperature > 60 && !rain)
{
  console.log('wear a light jacket')
} else {
  console.log('it will be chilly today')
}
